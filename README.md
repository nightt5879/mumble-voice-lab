...
**在线体验：** [nightt5879.github.io/mumble-voice-lab](https://nightt5879.github.io/mumble-voice-lab/?v=1.3.0-presets)

**GitHub 仓库：** [github.com/nightt5879/mumble-voice-lab](https://github.com/nightt5879/mumble-voice-lab)

**当前版本：** V1.3.0 presets，新增"我的角色"自定义保存库（localStorage 持久化），支持配置文件导入 / 导出，调好的角色可以一键存档、分享、跨设备复用。
...
**[打开 12 条样例试听页](https://nightt5879.github.io/mumble-voice-lab/showcase.html?v=1.3.0-presets)**
