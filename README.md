...
GitHub 仓库 README 会过滤内嵌音频播放器标签，所以这里提供可以直接打开播放的 WAV 链接；浏览器打开后会显示音频播放控件。想在网页里集中试听，可以打开 [在线试听页](https://nightt5879.github.io/mumble-voice-lab/listen.html)。
...
GitHub repository READMEs strip embedded audio player tags, so these links open playable WAV files directly in the browser. For an inline listening page with audio controls, open the [online listen page](https://nightt5879.github.io/mumble-voice-lab/listen.html).
