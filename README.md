...
**在线体验：** [nightt5879.github.io/mumble-voice-lab](https://nightt5879.github.io/mumble-voice-lab/?v=1.2.0-cozy)

**GitHub 仓库：** [github.com/nightt5879/mumble-voice-lab](https://github.com/nightt5879/mumble-voice-lab)

**当前版本：** V1.2.0 cozy redesign，全新贴纸式视觉系统、9 个角色专属虚拟形象、单屏紧凑布局，并加入"多人同时讲话"功能；试听样例同步用真实音频管线重新生成。
...
**[打开 12 条样例试听页](https://nightt5879.github.io/mumble-voice-lab/showcase.html?v=1.2.0-cozy)**
